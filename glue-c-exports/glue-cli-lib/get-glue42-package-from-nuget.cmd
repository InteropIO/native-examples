...
curl "https://globalcdn.nuget.org/packages/glue-cli-lib.1.8.0.nupkg?packageVersion=1.8.0" --output "./glue-cli-lib.nupkg"
echo Downloading io.Connect.NET package
echo Unpacking glue-cli-lib package
tar -xf glue-cli-lib.nupkg glue-cli-lib
curl "https://globalcdn.nuget.org/packages/io.connect.net.1.29.0.nupkg" --output "./io.connect.NET.nupkg"
